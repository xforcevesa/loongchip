...
${GCC_BIN}/loongarch32r-linux-gnusf-gcc -DKERNEL_ENTRY_ADDRESS=0x${KERNEL_ENTRY_ADDRESS} -c start.S -o start.o

${GCC_BIN}/loongarch32r-linux-gnusf-objdump -d start.o > start.s
${GCC_BIN}/loongarch32r-linux-gnusf-objdump -d vmlinux > test.s 

${GCC_BIN}/loongarch32r-linux-gnusf-objcopy -O binary -j .text start.o start.bin 

${GCC_BIN}/loongarch32r-linux-gnusf-objcopy -O binary -j .text -j __ex_table -j .notes -j .rodata -j __param -j .sdata \
