...
#define GLIBC_DYNAMIC_LINKER \
  "/lib" ABI_GRLEN_SPEC "/" \
  "%{mabi=ilp32d:ld-linux-loongarch-ilp32d.so.1;" \
    "mabi=ilp32f:ld-linux-loongarch-ilp32f.so.1;" \
    "mabi=ilp32s:ld-linux-loongarch-ilp32s.so.1;" \
    "mabi=lp64d:ld-linux-loongarch-lp64d.so.1;" \
