...
enum opt_code
{
  ...
  OPT_msimd_ = 1259,                         /* -msimd= */
  OPT_msingle_float = 1260,                  /* -msingle-float */
  OPT_msoft_float = 1261,                    /* -msoft-float */
  OPT_mstackrealign = 1262,                  /* -mstackrealign */
  OPT_mstrict_align = 1263,                  /* -mstrict-align */
  OPT_mtune_ = 1264,                         /* -mtune= */
  OPT_muclibc = 1265,                        /* -muclibc */
  OPT_mvecarg = 1266,                        /* -mvecarg */
  OPT_mveclibabi_ = 1267,                    /* -mveclibabi= */
  OPT_n = 1268,                              /* -n */
  OPT_no_canonical_prefixes = 1269,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1270,              /* -no-integrated-cpp */
  OPT_no_pie = 1271,                         /* -no-pie */
  OPT_nocpp = 1272,                          /* -nocpp */
  OPT_nodefaultlibs = 1273,                  /* -nodefaultlibs */
  OPT_nophoboslib = 1274,                    /* -nophoboslib */
  OPT_nostartfiles = 1275,                   /* -nostartfiles */
  OPT_nostdinc = 1276,                       /* -nostdinc */
  OPT_nostdinc__ = 1277,                     /* -nostdinc++ */
  OPT_nostdlib = 1278,                       /* -nostdlib */
  OPT_o = 1279,                              /* -o */
  OPT_p = 1280,                              /* -p */
  OPT_pass_exit_codes = 1281,                /* -pass-exit-codes */
  /* OPT_pedantic = 1282, */                 /* -pedantic */
  OPT_pedantic_errors = 1283,                /* -pedantic-errors */
  OPT_pg = 1284,                             /* -pg */
  OPT_pie = 1285,                            /* -pie */
  OPT_pipe = 1286,                           /* -pipe */
  OPT_posix = 1287,                          /* -posix */
  ...
  OPT_profile = 1299,                        /* -profile */
  OPT_pthread = 1300,                        /* -pthread */
  OPT_quiet = 1301,                          /* -quiet */
  OPT_r = 1302,                              /* -r */
  OPT_rdynamic = 1303,                       /* -rdynamic */
  OPT_remap = 1304,                          /* -remap */
  OPT_s = 1305,                              /* -s */
  OPT_save_temps = 1306,                     /* -save-temps */
  OPT_save_temps_ = 1307,                    /* -save-temps= */
  OPT_shared = 1308,                         /* -shared */
  OPT_shared_libgcc = 1309,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1310,               /* -shared-libphobos */
  /* OPT_specs = 1311, */                    /* -specs */
  OPT_specs_ = 1312,                         /* -specs= */
  OPT_static = 1313,                         /* -static */
  OPT_static_libasan = 1314,                 /* -static-libasan */
  OPT_static_libgcc = 1315,                  /* -static-libgcc */
  OPT_static_libgfortran = 1316,             /* -static-libgfortran */
  OPT_static_libgo = 1317,                   /* -static-libgo */
  OPT_static_liblsan = 1318,                 /* -static-liblsan */
  OPT_static_libmpx = 1319,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1320,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1321,               /* -static-libphobos */
  OPT_static_libstdc__ = 1322,               /* -static-libstdc++ */
  OPT_static_libtsan = 1323,                 /* -static-libtsan */
  OPT_static_libubsan = 1324,                /* -static-libubsan */
  OPT_static_pie = 1325,                     /* -static-pie */
  /* OPT_std_c__03 = 1326, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1327, */                /* -std=c++0x */
  OPT_std_c__11 = 1328,                      /* -std=c++11 */
  OPT_std_c__14 = 1329,                      /* -std=c++14 */
  OPT_std_c__17 = 1330,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1331, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1332, */                /* -std=c++1z */
  OPT_std_c__2a = 1333,                      /* -std=c++2a */
  OPT_std_c__98 = 1334,                      /* -std=c++98 */
  OPT_std_c11 = 1335,                        /* -std=c11 */
  OPT_std_c17 = 1336,                        /* -std=c17 */
  /* OPT_std_c18 = 1337, */                  /* -std=c18 */
  /* OPT_std_c1x = 1338, */                  /* -std=c1x */
  /* OPT_std_c89 = 1339, */                  /* -std=c89 */
  OPT_std_c90 = 1340,                        /* -std=c90 */
  OPT_std_c99 = 1341,                        /* -std=c99 */
  /* OPT_std_c9x = 1342, */                  /* -std=c9x */
  OPT_std_f2003 = 1343,                      /* -std=f2003 */
  OPT_std_f2008 = 1344,                      /* -std=f2008 */
  OPT_std_f2008ts = 1345,                    /* -std=f2008ts */
  OPT_std_f2018 = 1346,                      /* -std=f2018 */
  OPT_std_f95 = 1347,                        /* -std=f95 */
  OPT_std_gnu = 1348,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1349, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1350, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1351,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1352,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1353,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1354, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1355, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1356,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1357,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1358,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1359,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1360, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1361, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1362, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1363,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1364,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1365, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1366, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1367,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1368, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1369, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1370, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1371, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1372, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1373,                     /* -std=legacy */
  OPT_symbolic = 1374,                       /* -symbolic */
  OPT_t = 1375,                              /* -t */
  OPT_time = 1376,                           /* -time */
  OPT_time_ = 1377,                          /* -time= */
  OPT_tno_android_cc = 1378,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1379,                 /* -tno-android-ld */
  OPT_traditional = 1380,                    /* -traditional */
  OPT_traditional_cpp = 1381,                /* -traditional-cpp */
  OPT_trigraphs = 1382,                      /* -trigraphs */
  OPT_u = 1383,                              /* -u */
  OPT_undef = 1384,                          /* -undef */
  OPT_v = 1385,                              /* -v */
  OPT_version = 1386,                        /* -version */
  OPT_w = 1387,                              /* -w */
  OPT_wrapper = 1388,                        /* -wrapper */
  OPT_x = 1389,                              /* -x */
  OPT_z = 1390,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
