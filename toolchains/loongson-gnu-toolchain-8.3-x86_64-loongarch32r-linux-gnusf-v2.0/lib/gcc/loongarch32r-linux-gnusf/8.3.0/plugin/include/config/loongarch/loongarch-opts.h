...
#define TARGET_32BIT_STANDARD		  (la_target.isa.base == ISA_BASE_LA32V100)
#define TARGET_32BIT_REDUCED		  (la_target.isa.base == ISA_BASE_LA32RV100)
#define TARGET_32BIT (TARGET_32BIT_STANDARD || TARGET_32BIT_REDUCED)
