...
void Vsimu_top___024root__trace_init_top(Vsimu_top___024root* vlSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD void Vsimu_top___024root__trace_register(Vsimu_top___024root* vlSelf, VerilatedVcd* tracep);

VL_ATTR_COLD void Vsimu_top::trace(VerilatedVcdC* tfp, int levels, int options) {
    if (tfp->isOpen()) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vsimu_top::trace()' shall not be called after 'VerilatedVcdC::open()'.");
    }
