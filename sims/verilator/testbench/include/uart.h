...
#define UART_BUS_ENAB  0
#define UART_BUS_RW    1
#define UART_BUS_ADDR  2
#define UART_BUS_DATAI 3

struct UART_STA {
	unsigned int uart_config;
	bool uart_div_set;
	bool div_reinit;
	unsigned int div_val_1;
	unsigned int div_val_2;
	unsigned int div_val_3;
};
